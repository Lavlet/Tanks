...
namespace Tanks
{
    public class GameModel
    {
        ...
        public static Image bulletImage = Properties.Resources.BulletUp;
        ...
        public static int Score
        {
            ...
            {                
                score = value;
                ControllerMainWindow.ChangeScore(score);
            }
        }
        ...
        {//Первичный вариант игрового поля
         /*   for (int i = 0; i < 10; i++) //Верхние стены
            ...
            walls.Add(new Wall(125, 85));
            walls.Add(new Wall(100, 30));
            walls.Add(new Wall(30, 100));
        }
        ...
        public void DestroyAll()
        {
            ...
            walls.RemoveRange(0, walls.Count);
            tanks.RemoveRange(0, tanks.Count);
